...
public class Usuario {
	...
	@ApiModelProperty(example="email@email.com.br")				//atributo usuario deve ser um e-mail
	...
	public Usuario(long id, String nome, String usuario, String senha) { //Isto aqui é um construtor
		this.id = id;
		this.nome = nome;
